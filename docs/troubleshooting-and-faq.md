...
**For maximum privacy**: prefer a provider whose privacy terms fit your needs, or use Ollama / LM Studio for fully local inference so nothing leaves your machine. Self-host mode is available now for lifetime license holders — see [Copilot Plus and Self-Host](copilot-plus-and-self-host.md) for details.
